...
df_no_null2 = df_no_null2.drop(['fecha_retiro'], axis=1) # se elimina la variable fecha_retiro debido a que se sabe que ya se tienen los datos a la fecha y es innnecesaria para el analisis
df_no_null2.info()
